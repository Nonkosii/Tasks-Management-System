...
namespace AppointmentsManager.Controllers
{
    ...
    public class AppointmentController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<Appointment>>> GetAppointments()
        {
            ...
            return await _context.Appointments.Where(e => !e.Delete && !e.Done).ToListAsync();
        }
        ...
        public async Task<ActionResult<IEnumerable<Appointment>>> FilteredAppointments(Filter filters)
        {
            ...
            allData = allData.Where(e => e.Delete == filters.Delete).ToList();
        ...
        public async Task<IActionResult> PutAppointment(int id, Appointment appointment)
        {
            ...
            try
            {
                ...
                if (entry_.Delete != appointment.Delete)
                {
                    entry_.Delete = appointment.Delete;
                }
